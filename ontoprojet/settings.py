"""
Django settings for ontoprojet project.
...
SECRET_KEY = ')gf8h2hoi2u_**a5lihx5(pl#8xl-f()pu(#1_u(_&f%o_oguy'
...
WSGI_APPLICATION = 'ontoprojet.wsgi.application'
